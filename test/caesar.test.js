...
describe("caesar", () => {
  ...
  it("should work in reverse when encode is set to false", () => {
    const expected = "thinkful";
    const actual = caesar("wklqnixo", 3, false);
    expect(actual).to.equal(expected);
  });
  it("should work in reverse when encode is set to false and still ignore capitals, spaces, and non-letter characters", () => {
